class FromJsonBase {
  ...
  static DateTime? jsonToDateTime(Object? json) => (json is String) ? DateTime.tryParse(json) : null;
  ...
  static List<String> jsonToListString(Object? json) => (json is List) ? json.map((e) => jsonToString(e)).toList() : [];

  static List<int> jsonToListInt(Object? json) => (json is List) ? json.map((e) => jsonToInt(e)).toList() : [];

  static List<bool> jsonToListBool(Object? json) => (json is List) ? json.map((e) => jsonToBool(e)).toList() : [];
