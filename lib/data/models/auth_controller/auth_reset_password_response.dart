...
part 'auth_reset_password_response.g.dart';

@JsonSerializable()
class AuthResetPasswordResponse {
  @JsonKey(name: 'user')
  final User user;
  @JsonKey(name: 'payload')
  final Payload payload;

  const AuthResetPasswordResponse({
    this.user = const User(),
    this.payload = const Payload(),
  });

  factory AuthResetPasswordResponse.fromJson(Map<String, dynamic> json) =>
      _$AuthResetPasswordResponseFromJson(json);
  Map<String, dynamic> toJson() => _$AuthResetPasswordResponseToJson(this);

  AuthResetPasswordResponse copyWith({
    User? user,
    Payload? payload,
  }) {
