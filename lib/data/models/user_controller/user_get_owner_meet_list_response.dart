...
part 'user_get_owner_meet_list_response.g.dart';

@JsonSerializable()
class UserGetOwnerMeetListResponse {
  ...
  const UserGetOwnerMeetListResponse({
    this.address = '',
  ...
  factory UserGetOwnerMeetListResponse.fromJson(Map<String, dynamic> json) =>
      _$UserGetOwnerMeetListResponseFromJson(json);
  Map<String, dynamic> toJson() => _$UserGetOwnerMeetListResponseToJson(this);

  UserGetOwnerMeetListResponse copyWith({
    String? address,
    bool? attendRequired,
    Avatar? avatar,
    Category? category,
    ...
    return UserGetOwnerMeetListResponse(
