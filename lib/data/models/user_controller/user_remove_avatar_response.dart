...
part 'user_remove_avatar_response.g.dart';

@JsonSerializable()
class UserRemoveAvatarResponse {
  ...
  const UserRemoveAvatarResponse({
    this.accountClass = '',
    this.accountRank = 0,
    this.active = false,
    this.attendSeries = 0,
  ...
  factory UserRemoveAvatarResponse.fromJson(Map<String, dynamic> json) =>
      _$UserRemoveAvatarResponseFromJson(json);
  Map<String, dynamic> toJson() => _$UserRemoveAvatarResponseToJson(this);

  UserRemoveAvatarResponse copyWith({
    String? accountClass,
    int? accountRank,
    bool? active,
    int? attendSeries,
    ...
    return UserRemoveAvatarResponse(
