...
part 'user_upload_avatar_response.g.dart';

@JsonSerializable()
class UserUploadAvatarResponse {
  ...
  const UserUploadAvatarResponse({
    this.accountClass = '',
    this.accountRank = 0,
    this.active = false,
    this.attendSeries = 0,
  ...
  factory UserUploadAvatarResponse.fromJson(Map<String, dynamic> json) =>
      _$UserUploadAvatarResponseFromJson(json);
  Map<String, dynamic> toJson() => _$UserUploadAvatarResponseToJson(this);

  UserUploadAvatarResponse copyWith({
    String? accountClass,
    int? accountRank,
    bool? active,
    int? attendSeries,
    ...
    return UserUploadAvatarResponse(
