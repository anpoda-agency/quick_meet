...
part 'user_update_id_response.g.dart';

@JsonSerializable()
class UserUpdateIdResponse {
  ...
  factory UserUpdateIdResponse.fromJson(Map<String, dynamic> json) =>
      _$UserUpdateIdResponseFromJson(json);
  Map<String, dynamic> toJson() => _$UserUpdateIdResponseToJson(this);

  UserUpdateIdResponse copyWith({
    String? accountClass,
    int? accountRank,
    bool? active,
    int? attendSeries,
