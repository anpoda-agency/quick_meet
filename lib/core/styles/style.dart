...
ThemeData lightTheme = ThemeData(
    ...
    primaryColor: const Color(0xFF148044),
    // primaryColor: const Color(0xFF3365BD),
    // primaryColorBrightness: Brightness.light,
    primaryColorLight: const Color(0xFF99C4AC),
    primaryColorDark: const Color(0xFF148044),
    ...
    textSelectionTheme: TextSelectionThemeData(
      ...
      cursorColor: const Color(0xFF148044),
    ...
    inputDecorationTheme: const InputDecorationTheme(
      ...
      border: OutlineInputBorder(
          borderRadius: BorderRadius.all(Radius.circular(12)), borderSide: BorderSide(color: Color(0xFF9C9FB2))),
    ...
    chipTheme: const ChipThemeData(
        ...
        disabledColor: Color(0xFF778188),
        shape: StadiumBorder(),
        brightness: Brightness.light,
    ...
    appBarTheme: const AppBarTheme(
      ...
      actionsIconTheme: IconThemeData(color: Color(0xFF148044)),
    ...
    colorScheme: ColorScheme(
      primary: const Color(0xFF148044),
      // primaryVariant: const Color(0x1aF5E0C3),
      secondary: const Color(0xFF148044),
      ...
      onSurface: const Color(0xFF148044),
      surface: const Color(0xFF148044),
    ),
    ...
    dialogTheme: DialogTheme(
      ...
      titleTextStyle: const TextStyle(fontFamily: 'Wix Madefor Display', color: Color(0xFF148044)),
      contentTextStyle: TextStyle(
        fontFamily: 'Wix Madefor Display',
    ...
    navigationRailTheme: NavigationRailThemeData(
        ...
        selectedLabelTextStyle: const TextStyle(fontFamily: 'Wix Madefor Display', color: Color(0xFF148044))),
    ...
    popupMenuTheme: PopupMenuThemeData(
      ...
      textStyle: const TextStyle(fontFamily: 'Wix Madefor Display', color: Color(0xFF148044)),
    ),
    bannerTheme: MaterialBannerThemeData(
      // material banner theme
      backgroundColor: Colors.grey[150],
      contentTextStyle: const TextStyle(fontFamily: 'Wix Madefor Display', color: Color(0xFF148044)),
    ),
  ...
  ..addOwn(const OwnThemeFields(
      errorShade: Color.fromARGB(240, 255, 200, 200), textBaloon: Color.fromARGB(240, 255, 200, 200)));
